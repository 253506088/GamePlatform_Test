<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"F:\WWW\tp5\public/../application/index\view\index\youxizhongxin.html";i:1519892389;s:57:"F:\WWW\tp5\application\index\view\base\navigationBar.html";i:1519960123;s:50:"F:\WWW\tp5\application\index\view\base\footer.html";i:1519892102;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
		<title><?php echo (isset($web['gameName']) && ($web['gameName'] !== '')?$web['gameName']:'游戏中心'); ?></title>
					...
					<ul>
						...
						<li>
							<a href="<?php echo $vo['Link']; ?>">
								<img src="static/game/<?php echo $vo['Url']; ?>"/>
								<p class="p_game_name"><?php echo $vo['Name']; ?></p>
								<p class="p_game_detail"><?php echo $vo['Describe']; ?></p>
							</a>
						</li>
