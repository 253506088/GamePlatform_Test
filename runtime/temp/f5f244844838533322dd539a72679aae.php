<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:61:"F:\WWW\tp5\public/../application/admin\view\news\addNews.html";i:1519958438;s:50:"F:\WWW\tp5\application\admin\view\base\header.html";i:1519953005;s:63:"F:\WWW\tp5\application\admin\view\base\headernavigationBar.html";i:1519792091;s:57:"F:\WWW\tp5\application\admin\view\base\navigationBar.html";i:1519975026;s:50:"F:\WWW\tp5\application\admin\view\base\footer.html";i:1519783424;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
<head>
    <!--连接jQuery文件-->
            ...
            <form action="<?php echo (isset($form) && ($form !== '')?$form:''); ?>" enctype="multipart/form-data" method="post" id="form1" class="layui-form">
                ...
                <div class="layui-form-item layui-form-pane">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="Name" value="<?php echo (isset($news['Name']) && ($news['Name'] !== '')?$news['Name']:''); ?>" name="Name" required  lay-verify="required" placeholder="请输入新闻名称" autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <script id="container" name="content" type="text/plain">
                    <?php echo (isset($news['Content']) && ($news['Content'] !== '')?$news['Content']:''); ?>
...
//                        initialFrameWidth:1000,/* 宽度不变 */
                ...
                <!--<textarea class="layui-textarea" id="LAY_demo1" style="display: none" name="Details">-->
                    <!--<?php echo (isset($new['ProductDetails']) && ($new['ProductDetails'] !== '')?$new['ProductDetails']:''); ?>-->
                <!--</textarea>-->


                <!--id-->
                <input type="hidden" name="id" value="<?php echo (isset($news['Id']) && ($news['Id'] !== '')?$news['Id']:''); ?>">
