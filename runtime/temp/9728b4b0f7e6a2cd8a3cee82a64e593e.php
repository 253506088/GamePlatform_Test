<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"F:\WWW\tp5\public/../application/index\view\index\jiaruwomen.html";i:1519975909;s:57:"F:\WWW\tp5\application\index\view\base\navigationBar.html";i:1519975431;s:55:"F:\WWW\tp5\application\index\view\base\carouselimg.html";i:1519871800;s:50:"F:\WWW\tp5\application\index\view\base\footer.html";i:1519892102;}*/ ?>
<!DOCTYPE html>
<html>

	<head>
		<meta charset="utf-8">
		<title><?php echo (isset($web['joinUsName']) && ($web['joinUsName'] !== '')?$web['joinUsName']:'加入我们'); ?></title>
								...
								<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
									<li>
										<a href="<?php echo $vo['Link']; ?>">
											<div class="join_con_top">
												<span></span><p><?php echo $vo['Position']; ?></p>
											</div>
											<div class="join_con_detail">
												<p class="p_jiben">基本信息</p>
												<p>所属部门：<?php echo $vo['Department']; ?></p>
												<p>工作性质：<?php echo $vo['Nature']; ?></p>
												<p>人数：<?php echo $vo['Number']; ?></p>
												<p>预期月薪：<?php echo $vo['Salary']; ?></p>
												<p>发布时间：<?php echo $vo['Time']; ?></p>
											</div>
										</a>
									</li>
