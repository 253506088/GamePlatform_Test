<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:61:"F:\WWW\tp5\public/../application/admin\view\game\setGame.html";i:1519877979;s:50:"F:\WWW\tp5\application\admin\view\base\header.html";i:1519953005;s:63:"F:\WWW\tp5\application\admin\view\base\headernavigationBar.html";i:1519792091;s:57:"F:\WWW\tp5\application\admin\view\base\navigationBar.html";i:1519975026;s:50:"F:\WWW\tp5\application\admin\view\base\footer.html";i:1519783424;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
<head>
    <!--连接jQuery文件-->
...
<div class="layui-side layui-bg-black">
    ...
    <div class="layui-body">
        <!-- 内容主体区域 -->
        <blockquote class="layui-elem-quote">管理游戏信息</blockquote>
        <table class="layui-table" lay-filter="demo" lay-data="{
            ...
            <tr>
                ...
                <th lay-data="{field:'Name', width:205}">信息名称</th>
                <th lay-data="{field:'Describe', width:455}">信息详情</th>
                <th lay-data="{field:'Img', width:205}">图片</th>
                <th lay-data="{field:'Link', width:255, sort: true}">指向链接</th>
            ...
            layui.use('table', function(){
                ...
                table.on('tool(demo)', function(obj){
                    ...
                    if(obj.event === 'detail'){
                        ...
                        /* 删除游戏信息 */
                        layer.confirm('真的删除该信息么？', function(index){
                            var xmlhttp;
                            ...
                            /* 选择POST模式发送ID */
                            xmlhttp.open("POST","deleteGame",true);
                        ...
                        /* 修改游戏信息 */
                        window.location.href="modifyGamePage?id="+JSON.stringify(data.Id);
                    }
                });
