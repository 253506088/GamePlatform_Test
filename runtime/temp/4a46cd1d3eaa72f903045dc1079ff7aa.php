<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:67:"F:\WWW\tp5\public/../application/admin\view\aboutas\setAboutAs.html";i:1519965085;s:50:"F:\WWW\tp5\application\admin\view\base\header.html";i:1519953005;s:63:"F:\WWW\tp5\application\admin\view\base\headernavigationBar.html";i:1519792091;s:57:"F:\WWW\tp5\application\admin\view\base\navigationBar.html";i:1519975026;s:50:"F:\WWW\tp5\application\admin\view\base\footer.html";i:1519783424;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
<head>
    <!--连接jQuery文件-->
        ...
        <div class="site-demo-button" id="layerDemo" style="margin-bottom: 0;">
            <form action="<?php echo (isset($form) && ($form !== '')?$form:''); ?>" enctype="multipart/form-data" method="post" id="form1" class="layui-form">
                ...
                <script id="container" name="content" type="text/plain">
                    <?php echo (isset($aboutas['Content']) && ($aboutas['Content'] !== '')?$aboutas['Content']:''); ?>
...
//                        initialFrameWidth:1000,/* 宽度不变 */
                ...
                <!--id-->
                <input type="hidden" name="id" value="<?php echo (isset($aboutas['Id']) && ($aboutas['Id'] !== '')?$aboutas['Id']:''); ?>">
