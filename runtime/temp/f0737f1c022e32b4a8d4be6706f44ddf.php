<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:75:"F:\WWW\tp5\public/../application/admin\view\Carouselimg\addcarouselimg.html";i:1519868989;s:50:"F:\WWW\tp5\application\admin\view\base\header.html";i:1519953005;s:63:"F:\WWW\tp5\application\admin\view\base\headernavigationBar.html";i:1519792091;s:57:"F:\WWW\tp5\application\admin\view\base\navigationBar.html";i:1519975026;s:50:"F:\WWW\tp5\application\admin\view\base\footer.html";i:1519783424;}*/ ?>
<!DOCTYPE html>
<html lang="cn">
<head>
    <!--连接jQuery文件-->
        ...
        <div class="site-demo-button" id="layerDemo" style="margin-bottom: 0;">
            <form action="<?php echo (isset($form) && ($form !== '')?$form:''); ?>" enctype="multipart/form-data" method="post" id="form1" class="layui-form">
                ...
                <!--<div class="layui-form-item">-->
                    ...
                    <!--<div class="layui-input-block">-->
                        <!--<select name="id" lay-filter="aihao">-->
                            <!--<?php if(is_array($pageNameList) || $pageNameList instanceof \think\Collection || $pageNameList instanceof \think\Paginator): $i = 0; $__LIST__ = $pageNameList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>-->
                                <!--<option value="<?php echo $vo['pageId']; ?>"><?php echo $vo['pageName']; ?></option>-->
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <?php if(is_array($pageNameList) || $pageNameList instanceof \think\Collection || $pageNameList instanceof \think\Paginator): $i = 0; $__LIST__ = $pageNameList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;switch($key): case "0": ?>
                                    <input type="radio" name="PageId" value="<?php echo $vo['pageId']; ?>" title="<?php echo $vo['pageName']; ?>" checked>
                                <?php break; default: ?>
                                    <input type="radio" name="PageId" value="<?php echo $vo['pageId']; ?>" title="<?php echo $vo['pageName']; ?>">
                ...
                <div class="layui-form-item layui-form-pane">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="Link" value="<?php echo (isset($carouselimg['Link']) && ($carouselimg['Link'] !== '')?$carouselimg['Link']:''); ?>" name="Link" required  lay-verify="required" placeholder="请输入跳转链接" autocomplete="off" class="layui-input">
                    </div>
                </div>
